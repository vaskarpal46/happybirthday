...
$('document').ready(function(){
	...
	function loopOne() {
		var randleft = 400*Math.random();
		var randtop = 150*Math.random();
	...
	$('#wish_message').click(function(){
		...
		$('#b22').animate({top:240, left: vw*0+36},500);
		...
		$('#b77').animate({top:240, left: vw*2-85},500);
